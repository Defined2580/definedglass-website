/*
  ...
  1. Upload your photo to the right subfolder on GitHub:
       images/shower-doors/   → for shower door photos
       images/mirrors/        → for mirror photos
       images/railings/       → for railing photos
       images/office/         → for office partition photos
       images/exterior/       → for storefront/exterior photos

  2. Add ONE LINE to the list below, following this format:
       { src: 'images/FOLDER/FILENAME.jpg', cat: 'CATEGORY', alt: 'Short description' },
